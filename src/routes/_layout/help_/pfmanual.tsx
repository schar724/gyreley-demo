...
export const Route = createFileRoute("/_layout/help_/pfmanual")({
  component: PFManual,
});
  ...
  return (
    <div>
      <div className="pr-3">
        ...
        <hr />
        <br />
        <div className="dropdown hidden sm:block shadow-md">
          <button className="dropbtn">Jump to Section</button>
          <div className="dropdown-content">
            <a href="#/help/pfmanual#top">Top</a>
            <a href="#/help/pfmanual#cl1">Description</a>
            <a href="#/help/pfmanual#cl2">Parts</a>
            <a href="#/help/pfmanual#cl3">Setup</a>
            <a href="#/help/pfmanual#cl4">Device Use</a>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="p-2">
            This device is designed to assist operators in locating various
            types of underground assets. It uses advanced sensing technology to
            detect and provide feedback on buried objects without direct access.
          </p>
          <p className="p-2">
        ...
        <div id="cl3">
          ...
          <div id="pairing">
            ...
            <p className="p-3">
              Ensure both units are powered on. Use the pairing option in the
              menu to establish a connection.
            </p>
            <div id="instructions">
